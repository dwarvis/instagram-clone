...
import edu.cis.instagramclone.materialcamera.internal.*;
...
public interface BaseCaptureInterface {
  ...
  @edu.cis.instagramclone.materialcamera.internal.BaseCaptureActivity.CameraPosition
...
//  void setUseStillshot(boolean bool);
  ...
  @edu.cis.instagramclone.materialcamera.internal.BaseCaptureActivity.FlashMode
  int getFlashMode();
