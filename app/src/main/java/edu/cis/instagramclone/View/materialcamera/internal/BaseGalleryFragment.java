...
public abstract class BaseGalleryFragment extends Fragment
    implements edu.cis.instagramclone.View.materialcamera.internal.CameraUriInterface, View.OnClickListener {
...
//    mPrimaryColor = getArguments().getInt(edu.cis.instagramclonetest.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR);
