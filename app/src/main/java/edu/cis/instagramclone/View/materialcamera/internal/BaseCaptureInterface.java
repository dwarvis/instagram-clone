...
public interface BaseCaptureInterface {
  ...
  @edu.cis.instagramclone.View.materialcamera.internal.BaseCaptureActivity.CameraPosition
...
//  void setUseStillshot(boolean bool);
  ...
  @edu.cis.instagramclone.View.materialcamera.internal.BaseCaptureActivity.FlashMode
  int getFlashMode();
