...
import edu.cis.instagramclone.View.materialcamera.util.Degrees;
import edu.cis.instagramclone.View.materialcamera.util.ImageUtil;
import edu.cis.instagramclone.View.materialcamera.util.ManufacturerUtil;

import static edu.cis.instagramclone.View.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static edu.cis.instagramclone.View.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static edu.cis.instagramclone.View.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static edu.cis.instagramclone.View.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static edu.cis.instagramclone.View.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_AUTO;
import static edu.cis.instagramclone.View.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_OFF;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  edu.cis.instagramclone.View.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new edu.cis.instagramclone.View.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof edu.cis.instagramclone.View.materialcamera.internal.CameraPreview)
