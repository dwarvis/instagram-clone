...
import edu.cis.instagramclone.View.easyvideoplayer.EasyVideoCallback;
import edu.cis.instagramclone.View.easyvideoplayer.EasyVideoPlayer;
...
public class PlaybackVideoFragment extends Fragment
  ...
  public static PlaybackVideoFragment newInstance(
    ...
    args.putBoolean(edu.cis.instagramclone.View.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, allowRetry);
    args.putInt(edu.cis.instagramclone.View.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR, primaryColor);
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    if (getArguments().getBoolean(edu.cis.instagramclone.View.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, true))
